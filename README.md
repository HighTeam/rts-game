...
**alpha_v0.2** on `main`: Earth loop, default HUD / diplomacy, 2–4p lockstep (CLI `--players` / `--player-slot`), reconnect + AI takeover, SP save/load, packed `assets.dat`. See [LOCKSTEP.md](docs/LOCKSTEP.md). Open: 8-player CI smoke, MP coordinated save/load, map redesign — [BACKLOG.md](docs/BACKLOG.md).
