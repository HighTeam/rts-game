...
Every relative path in `src/core/constants.hpp` SFX/texture tables must exist under this tree
or packing fails (map-ping uses `sfx/Cringemarine/look-here.wav`).
