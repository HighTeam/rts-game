...
inline constexpr int WORKER_GATHER_INTERVAL_TICKS = 27;
...
inline constexpr unsigned int OPENGL_DEPTH_BITS = 24U;
inline constexpr unsigned int OPENGL_STENCIL_BITS = 8U;
inline constexpr unsigned int HUD_OCCLUSION_STENCIL_REF = 1U;
...
inline constexpr int DEFAULT_TOWN_CENTER_VISION_RANGE = 9;
...
inline constexpr int CAMERA_MAP_BOUNDS_PADDING_TILES = 0;
...
inline constexpr std::string_view HUD_HOVER_TRADES = "Trades";
...
inline constexpr float RENDER_UNIT_BUILDING_FRONT_LINE_SLACK_TILES = 0.25F;
...
inline constexpr int RENDER_OCCLUSION_PROBE_RADIUS = 8;
inline constexpr int RENDER_RANGE_CIRCLE_SEGMENTS = 64;
inline constexpr float RENDER_RANGE_CIRCLE_WIDTH_PX = 3.0F;
...
inline constexpr int TOWER_BUILD_WOOD_COST = 125;
inline constexpr int TOWER_BUILD_MONEY_COST = 50;
inline constexpr int TOWER_MAX_HP = 900;
inline constexpr int TOWER_VISION_RANGE = 8;
inline constexpr int TOWER_ATTACK_RANGE_TILES = 7;
inline constexpr int TOWER_BLIND_RANGE_TILES = 1;
...
inline constexpr int TRADES_GOLD_COST = 125;
inline constexpr int TRADE_WOOD_STEP = 100;
inline constexpr int TRADE_FOOD_STEP = 100;
inline constexpr int TRADE_GOLD_STEP = 100;
inline constexpr int TRADE_MANA_STEP = 25;
...
inline constexpr int GARDEN_MAX_PER_PLAYER = 5;
inline constexpr int GARDEN_PROD_WOOD = 1;
inline constexpr int GARDEN_PROD_FOOD = 1;
inline constexpr int GARDEN_PROD_SPEED_MULTIPLIER = 4;
inline constexpr int GARDEN_PROD_INTERVAL_SECONDS = 10;
inline constexpr int GARDEN_PROD_INTERVAL_TENTHS =
    (GARDEN_PROD_INTERVAL_SECONDS * 10) / GARDEN_PROD_SPEED_MULTIPLIER;
...
inline constexpr int TOWER_PIERCE_ATTACK = 6;
inline constexpr int TOWER_MELEE_ARMOR = 1;
inline constexpr int TOWER_PIERCE_ARMOR = 8;
inline constexpr int TOWER_ATTACK_COOLDOWN_TICKS = SIM_TICKS_PER_SECOND * 2;
inline constexpr int STRUCTURE_DEFAULT_MELEE_ARMOR = 1;
inline constexpr int STRUCTURE_DEFAULT_PIERCE_ARMOR = 5;
inline constexpr int ATTACK_REVEAL_DURATION_TICKS = SIM_TICKS_PER_SECOND * 3;
inline constexpr int MAGE_MELEE_ATTACK = 2;
inline constexpr int MAGE_MELEE_ARMOR = 1;
inline constexpr int MAGE_PIERCE_ATTACK = 6;
inline constexpr int MAGE_PIERCE_ARMOR = 3;
...
inline constexpr float ARROW_PROJECTILE_RADIUS = 0.08F;
...
inline constexpr int HUD_UNIT_PORTRAIT_COUNT = 6;
inline constexpr int HUD_UNIT_PORTRAIT_TILE_SIZE_PX = 96;
inline constexpr int HUD_CIV_LOGO_COUNT = 4;
inline constexpr int HUD_CIV_LOGO_TILE_SIZE_PX = 192;
inline constexpr std::uint32_t UNIT_SEX_SPAWN_SALT = 0xA3C59AC3U;
inline constexpr std::uint32_t UNIT_SEX_SPAWN_SLOT_MIX = 0x9E3779B1U;
inline constexpr std::uint32_t UNIT_SEX_SPAWN_CATEGORY_MIX = 0x85EBCA6BU;
inline constexpr std::uint32_t UNIT_SEX_SPAWN_ORDINAL_MIX = 0xC2B2AE35U;
enum class Civilization : std::uint8_t {
    Earth = 0,
    Water = 1,
    Fire = 2,
    Air = 3,
};
inline constexpr int CIVILIZATION_COUNT = 4;
enum class UnitSex : std::uint8_t {
    Male = 0,
    Female = 1,
};
inline constexpr int UNIT_SEX_COUNT = 2;
...
inline constexpr float RENDER_ARROW_PROJECTILE_R = 0.72F;
inline constexpr float RENDER_ARROW_PROJECTILE_G = 0.55F;
inline constexpr float RENDER_ARROW_PROJECTILE_B = 0.28F;
inline constexpr float RENDER_RANGE_CIRCLE_R = 0.20F;
inline constexpr float RENDER_RANGE_CIRCLE_G = 0.85F;
inline constexpr float RENDER_RANGE_CIRCLE_B = 0.25F;
...
inline constexpr int GARDEN_PROD_INTERVAL_TICKS =
    (SIM_TICKS_PER_SECOND * GARDEN_PROD_INTERVAL_SECONDS) / GARDEN_PROD_SPEED_MULTIPLIER;
...
inline constexpr int GROUND_TYPE_COUNT = 4;
...
inline constexpr int HUD_CONFIRM_DIALOG_PADDING_PX = 16;
...
inline constexpr float HUD_OPTIONS_FRAME_A = 0.55F;
inline constexpr float HUD_HOVER_TOOLTIP_GAP_PX = 16.0F;
inline constexpr float HUD_DIPLOMACY_ROW_BG_A = 0.42F;
inline constexpr int HUD_DIPLOMACY_CHECKBOX_SIZE_PX = 16;
inline constexpr float HUD_AUDIO_PERCENT_GAP_PX = 8.0F;
...
inline constexpr float MINIMAP_INNER_WELL_A = 1.0F;
...
enum class BuildingRangeDisplayMode : std::uint8_t {
    Never = 0,
    Selected = 1,
    Always = 2,
};

enum class HudStyle : std::uint8_t {
    Default = 0,
    Aoe = 1,
};

inline constexpr std::array<std::string_view, 3> BUILDING_RANGE_DISPLAY_LABELS{
    "Shooting range: Never",
    "Shooting range: Only when selected",
...
inline constexpr float HUD_MENU_BUTTON_WIDTH_FRACTION = 0.09F;
inline constexpr float HUD_DIPLOMACY_BUTTON_WIDTH_FRACTION = 0.13F;
inline constexpr float HUD_MENU_BUTTON_HEIGHT_FRACTION = 0.05F;
inline constexpr int HUD_MENU_BUTTON_MARGIN_PX = 10;
inline constexpr float HUD_DIPLOMACY_BUTTON_GAP_PX = 8.0F;
inline constexpr float HUD_DIPLOMACY_WIDTH_FRACTION = 0.46F;
inline constexpr float HUD_DIPLOMACY_HEIGHT_FRACTION = 0.62F;
inline constexpr int HUD_DIPLOMACY_TAB_HEIGHT_PX = 34;
inline constexpr int HUD_DIPLOMACY_ROW_HEIGHT_PX = 36;
inline constexpr int HUD_DIPLOMACY_CLOSE_WIDTH_PX = 110;
inline constexpr int HUD_DIPLOMACY_ACTION_WIDTH_PX = 150;
inline constexpr int HUD_DIPLOMACY_SEND_WIDTH_PX = 90;
inline constexpr int HUD_DIPLOMACY_ALLY_VICTORY_WIDTH_PX = 220;
inline constexpr int HUD_DIPLOMACY_TRADE_ICON_SIZE_PX = 18;
inline constexpr float HUD_DIPLOMACY_NAME_WIDTH_FRACTION = 0.28F;
inline constexpr int HUD_TAB_SCOREBOARD_ROW_HEIGHT_PX = 26;
inline constexpr int HUD_TAB_SCOREBOARD_WIDTH_PX = 320;
inline constexpr int HUD_CHAT_CHANNEL_BUTTON_WIDTH_PX = 90;
inline constexpr std::string_view HUD_DIPLOMACY_LABEL = "Diplomacy";
inline constexpr std::string_view DIPLOMACY_TAB_CHAT = "Chat";
inline constexpr std::string_view DIPLOMACY_TAB_TRADES = "Trades";
inline constexpr std::string_view DIPLOMACY_TAB_TEAMS = "Teams";
inline constexpr std::string_view DIPLOMACY_CLOSE_LABEL = "Close";
inline constexpr std::string_view DIPLOMACY_SEND_TRADES_LABEL = "Send trades";
inline constexpr std::string_view DIPLOMACY_SEND_MESSAGE_LABEL = "Send";
inline constexpr std::string_view DIPLOMACY_CONFIRM_LABEL = "Confirm";
inline constexpr std::string_view DIPLOMACY_ALLY_LABEL = "Ally";
...
inline constexpr std::string_view GAME_MENU_RESIGN_LABEL = "Resign";
inline constexpr std::string_view GAME_MENU_EXIT_LABEL = "Leave";
inline constexpr std::string_view GAME_MENU_RESIGN_CONFIRM_TEXT = "Are you sure you want to resign?";
inline constexpr std::string_view GAME_MENU_LEAVE_CONFIRM_TEXT =
    "Are you sure you want to leave the match?";
inline constexpr std::string_view GAME_MENU_LEAVE_CONFIRM_TEXT_LINE_2 =
    "You will resign automatically.";
inline constexpr std::string_view GAME_MENU_DIALOG_YES_LABEL = "Yes";
inline constexpr std::string_view GAME_MENU_DIALOG_NO_LABEL = "No";
inline constexpr std::string_view MULTIPLAYER_RECONNECT_PROMPT_LABEL = "Reconnect to Match";
inline constexpr std::string_view MATCH_STAT_WOOD_GATHERED_PREFIX = "Wood Gathered: ";
inline constexpr std::string_view MATCH_STAT_FOOD_GATHERED_PREFIX = "Food Gathered: ";
inline constexpr std::string_view MATCH_STAT_MONEY_GATHERED_PREFIX = "Money Gathered: ";
inline constexpr std::string_view MATCH_STAT_MANA_GATHERED_PREFIX = "Mana Gathered: ";
inline constexpr std::string_view MATCH_STAT_TRADES_SENT_PREFIX = "Trades sent: ";
inline constexpr std::string_view MATCH_STAT_TRADES_RECEIVED_PREFIX = "Trades received: ";
inline constexpr std::string_view CHAT_CHANNEL_ALL_LABEL = "All";
inline constexpr std::string_view CHAT_CHANNEL_ALLIES_LABEL = "Allies";
inline constexpr std::string_view CHAT_ALLY_PREFIX = "[Ally] ";
inline constexpr std::string_view CHAT_RELATIONSHIP_MID = " has changed relationship with you to ";
inline constexpr std::string_view DIPLOMACY_TRADES_LOCKED_LABEL =
    "Trades are not available for you by now";
inline constexpr std::string_view DIPLOMACY_BLOCKED_TEAMS_LABEL = "Team changes are blocked";
inline constexpr std::string_view LOBBY_BLOCK_TEAM_CHANGES_NO = "Block team changes: No";
inline constexpr std::string_view LOBBY_BLOCK_TEAM_CHANGES_YES = "Block team changes: Yes";
inline constexpr std::string_view LOBBY_ALLOW_SPECTATORS_NO = "Allow spectators: No";
inline constexpr std::string_view LOBBY_ALLOW_SPECTATORS_YES = "Allow spectators: Yes";
inline constexpr std::string_view MULTIPLAYER_RECONNECT_LABEL = "Reconnect";
inline constexpr float HUD_GAME_MENU_WIDTH_FRACTION = 0.10F;
inline constexpr float HUD_GAME_MENU_BUTTON_HEIGHT_PX = 42.0F;
...
inline constexpr float HUD_DEFAULT_MINIMAP_INSET_U = 0.22F;
inline constexpr float HUD_DEFAULT_DECOR_WIDTH_U = 6.0F;
inline constexpr float HUD_DEFAULT_DECOR_HEIGHT_U = 3.0F;
inline constexpr float HUD_DEFAULT_DECOR_HATCH_HEIGHT_U = 1.0F;
inline constexpr float HUD_DEFAULT_SIDE_BOX_WIDTH_U = 10.0F;
inline constexpr float HUD_DEFAULT_SIDE_BOX_HEIGHT_U = 4.0F;
inline constexpr float HUD_DEFAULT_CHAMFER_U = 1.0F;
inline constexpr float HUD_DEFAULT_TOP_BAR_WIDTH_U = 12.0F;
inline constexpr float HUD_DEFAULT_TOP_BAR_HEIGHT_U = 1.0F;
inline constexpr float HUD_DEFAULT_LOGO_SIZE_U = 3.0F;
inline constexpr float HUD_DEFAULT_MENU_BUTTON_WIDTH_U = 3.0F;
inline constexpr float HUD_DEFAULT_DIPLOMACY_BUTTON_WIDTH_U = 4.0F;
inline constexpr float HUD_DEFAULT_RESOURCE_USABLE_WIDTH_U = 8.0F;
inline constexpr float HUD_DEFAULT_UNIT_ICON_CENTER_X_U = 24.15F;
inline constexpr float HUD_DEFAULT_UNIT_ICON_CENTER_Y_U = 14.90F;
inline constexpr float HUD_DEFAULT_UNIT_ICON_HALF_U = 0.72F;
inline constexpr float HUD_DEFAULT_UNIT_ICON_CORNER_RADIUS_U = 0.28F;
inline constexpr float HUD_DEFAULT_CIRCLE_BUTTON_OFFSET_X_U = 1.9F;
inline constexpr float HUD_DEFAULT_CIRCLE_BUTTON_Y_U = 17.3F;
inline constexpr float HUD_DEFAULT_CIRCLE_BUTTON_RADIUS_U = 0.4F;
inline constexpr float HUD_DEFAULT_OPTIONS_INSET_LEFT_U = 1.0F;
inline constexpr float HUD_DEFAULT_OPTIONS_INSET_RIGHT_U = 3.0F;
inline constexpr float HUD_DEFAULT_OPTIONS_INSET_TOP_U = 0.15F;
inline constexpr float HUD_DEFAULT_OPTIONS_INSET_BOTTOM_U = 0.15F;
inline constexpr float HUD_LABEL_INSET_PX = 4.0F;
inline constexpr int HUD_DEFAULT_CIRCLE_SIDES = 20;
inline constexpr int HUD_DEFAULT_ROUND_CORNER_SIDES = 5;
inline constexpr float HUD_DEFAULT_HATCH_STEP_U = 0.18F;
inline constexpr float HUD_DEFAULT_HATCH_MIN_STEP_PX = 3.0F;
inline constexpr float HUD_SAVE_LOAD_WIDTH_FRACTION = 0.42F;
inline constexpr float HUD_SAVE_LOAD_HEIGHT_FRACTION = 0.62F;
inline constexpr float HUD_SAVE_CONFIRM_WIDTH_FRACTION = 0.38F;
inline constexpr float HUD_SAVE_CONFIRM_HEIGHT_FRACTION = 0.24F;
inline constexpr float HUD_DIALOG_BUTTON_WIDTH_PX = 72.0F;
inline constexpr float HUD_DIALOG_BUTTON_HEIGHT_PX = 26.0F;
inline constexpr int HUD_GAME_MENU_BUTTON_COUNT = 7;
...
inline constexpr float HUD_MENU_SCRIM_A = 0.62F;
inline constexpr float HUD_MENU_SCRIM_BLUR_A = 0.18F;
inline constexpr float HUD_MATCH_RESULT_SCRIM_A = 0.82F;
inline constexpr float HUD_MATCH_RESULT_SCRIM_BLUR_A = 0.28F;
inline constexpr float MOVE_WORLD_APPROACH_STEP_TILES = 0.12F;
inline constexpr int MOVE_WORLD_APPROACH_MAX_STEPS = 48;
...
inline constexpr float HUD_MATCH_RESULT_HEIGHT_FRACTION = 0.72F;
inline constexpr int HUD_MATCH_RESULT_TITLE_PIXEL_SCALE = 3;
inline constexpr float HUD_MATCH_RESULT_LINE_GAP_PX = 8.0F;
inline constexpr float HUD_MATCH_RESULT_EXIT_WIDTH_PX = 210.0F;
...
inline constexpr int WORKER_MELEE_ATTACK = 1;
inline constexpr int WORKER_MELEE_ARMOR = 0;
inline constexpr int WORKER_PIERCE_ATTACK = 0;
inline constexpr int WORKER_PIERCE_ARMOR = 0;
inline constexpr int MILITIA_MELEE_ATTACK = 4;
inline constexpr int MILITIA_MELEE_ARMOR = 2;
inline constexpr int MILITIA_PIERCE_ATTACK = 0;
inline constexpr int MILITIA_PIERCE_ARMOR = 0;
inline constexpr int MOVE_UNWALKABLE_GOAL_SEARCH_RADIUS = 48;
inline constexpr int MOVE_GROUP_SETTLE_ATTEMPTS = 24;
inline constexpr int MOVE_GROUP_SETTLE_EXTRA_RINGS = 6;
inline constexpr float MOVE_GROUP_SETTLE_SPACING_TILES = 0.52F;
