...
Open reconnect caveats (not fixed on `main`): draft PRs **#72** (mid-barrier ready wipe) and
**#75** (command-sequence reset + late `ResyncReady` bystander sync) — see Remaining gaps.
