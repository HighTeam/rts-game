...
| Map-ping SFX is a silent placeholder | `sfx/Cringemarine/look-here.wav` is tracked so `aoa_pack_assets` / CI POST_BUILD succeed, but it is silent PCM until real VO replaces it (`SFX_LOOK_HERE_RELATIVE_PATH`) |
