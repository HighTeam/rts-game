...
| Packed `assets.dat` + NSIS installer script | Shipped baseline (map-ping SFX is a silent placeholder) |
...
- [ ] **Map-ping SFX VO** — replace silent `sfx/Cringemarine/look-here.wav` placeholder with real look-here VO (`SFX_LOOK_HERE_RELATIVE_PATH`)
