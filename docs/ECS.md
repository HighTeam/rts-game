...
1. `run_building_process_system` — train / research / construction progress (training that finishes
   at 100% but cannot spawn refunds only on pop-cap today; blocked spawn tiles leave the process
   stuck until draft PR **#77**)
